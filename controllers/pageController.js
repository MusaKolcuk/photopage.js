...
const sendMail = async (req, res) => {
    ...
    try {
        // npm nodemailer paketi hompage sayfasindan kopyaladim.
  ...
  // gelen mailin ozellikleri
await transporter.sendMail({
    to: "musakolcuk@gmail.com", // list of receivers
    subject: "MAIL FROM ${req.body.email}", //req.body.email kullanicinin mail gonderirken forum da girecegi email
